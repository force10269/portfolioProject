...
const ProjectData = [
  {
    ...
    description:
      "Using Python scripts which utilize the OpenCV library and the ImageJ interface to perform an analysis of cell images containing dynein proteins.",
  ...
  },
  {
    ...
    description:
      "This page! Everything you see here was created with the ReactJS framework and Bootstrap. Deployment achieved through Netlify.",
  ...
  },
  {
    ...
    description:
      "A software development blog I made to keep track of personal software dev fiascos or tidbits of information I could really use in the future. Deployed at: ",
  ...
  },
  {
    ...
    description:
      "Discord bots utilizing the OpenAI API to interface with ChatGPT in Discord. Also utilizes the Tiktoken library to see how many tokens any given prompt is, including images and .txt files.",
